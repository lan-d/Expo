<p>Variables predefinidas
PHP proporciona una gran cantidad de variables predefinidas para todos los scripts. Las variables representan de todo, desde variables externas hasta variables de entorno incorporadas, desde los últimos mensajes de error hasta los últimos encabezados recuperados.</p>

<p>Véase también la pregunta frecuente titulada "¿Cómo me afecta register_globals?"</p>

<p>Tabla de contenidos<br>
...
$_ENV — Variables de entorno<br>
$_COOKIE — Cookies HTTP<br>
$php_errormsg — El último mensaje de error<br>
...
$argv — Array de argumentos pasados a un script</p>
